...
function defaultCompany()
{
	...
	echo "<link href='$path_to_root/themes/$def_theme/default.css' rel='stylesheet' type='text/css'> \n";
 	echo "<link href='$path_to_root/themes/$def_theme/images/favicon.ico' rel='icon' type='image/x-icon'> \n";
	send_scripts();
	echo $js;
	echo "</head>\n";
  ...
  echo "<a target='_blank' href='$power_url'><img src='$path_to_root/themes/$def_theme/images/logo.png' alt='SS ERP' height='50' onload='fixPNG(this)' border='0' /></a>";
	echo "</td>\n";
	end_row();
