...
if (isset($_GET['AddedID'])) 
{
    ...
    submenu_print(_("&Print Journal Voucher"), $trans_type, $trans_no, 'prtopt'); //moodlearning
...
function create_cart($type=0, $trans_no=0)
{
	...
	$_POST['jv_no'] = $cart->custom_no; /**========MOODLEARNING=======*/
...
/*=======================MOODLEARNING==========================*/
	if (!get_post('jv_no')){
		...
		if (checkNoIfExists($_POST['jv_no'], $fiscal['begin'], $fiscal['end']) > 0){
...
if (isset($_POST['Process']))
{
	...
	$cart->custom_no = $_POST['jv_no']; /*=======MOODLEARNING==============*/
