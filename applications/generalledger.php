...
class general_ledger_app extends application
{
	function general_ledger_app()
	{
		...
		$this->add_rapp_function(0, _("Cash Disbursement"),
			"gl/cash_disbursement.php?NewDisbursement=Yes", 'SA_JOURNALENTRY', MENU_TRANSACTION);
		$this->add_lapp_function(0, _("Bank Payments"),
		...
		$this->add_rapp_function(0, _("&Journal Entry / Voucher"),
		...
		$this->add_lapp_function(1, _("&Check/Journal Voucher Inquiry"),
			"gl/inquiry/custom_inquiry.php?", 'SA_GLANALYTIC', MENU_INQUIRY);
...
==================================================================================================================*/
		$this->add_rapp_function(1, _("Subsidiary Ledger Report"),
			"gl/ml/subsidiary_ledger.php?", 'SA_GLANALYTIC', MENU_INQUIRY);
/*================================================================================================================*/
		...
		/*=====================MOODLEARNING=-==============*/
		$this->add_lapp_function(2, _("Booklet"),
			"gl/ml/booklet.php?", 'SA_BANKACCOUNT', MENU_MAINTENANCE);
		/*==================================================*/
