...
class inventory_app extends application
{
	function inventory_app()
	{
		...
		$this->add_lapp_function(1, _("Author and Royalty Inquiry and Report"),
			"inventory/view_royalties.php?", 'SA_ITEM', MENU_ENTRY);
		

		$this->add_module(_("Maintenance"));
		$this->add_lapp_function(2, _("&Items / Books"),
			"inventory/manage/items.php?", 'SA_ITEM', MENU_ENTRY);
		/*=====================MOODLEEARNING=============================*/
		$this->add_lapp_function(2, _("Book Levels"),
			"inventory/ml/levels.php?", 'SA_INVENTORYLOCATION', MENU_MAINTENANCE);
		/*===============================================================*/
		$this->add_rapp_function(2, _("&Manage Authors"),//ML
			"inventory/author/author.php?", 'SA_ITEM', MENU_MAINTENANCE);//ML
		...
		$this->add_lapp_function(2, _("Item &Categories / Subjects"),
