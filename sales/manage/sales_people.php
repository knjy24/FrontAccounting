...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') 
{
	...
	if ($input_error != 1)
	{
    	if ($selected_id != -1) 
    	{
    		...
    		/*moodlearning edit update_salesman($_POST['imc_code'])*/
			update_salesman($selected_id, $_POST['imc_code'], $_POST['salesman_name'], $_POST['salesman_phone'], $_POST['salesman_fax'],
				$_POST['salesman_email'], input_num('provision'), input_num('break_pt'), input_num('provision2'));
    	}
    	else
    	{
    		/*Selected group is null cos no item selected on first time round so must be adding a record must be submitting new entries in the new Sales-person form */
    		/*moodlearning edit add_salesman($_POST['imc_code'])*/
			add_salesman($_POST['imc_code'], $_POST['salesman_name'], $_POST['salesman_phone'], $_POST['salesman_fax'],
				$_POST['salesman_email'], input_num('provision'), input_num('break_pt'), input_num('provision2'));
    	}
...
/*==moodlearning edit in $th = array(_("IMC Code"));*/
$th = array(_("IMC Code"), _("Name"), _("Phone"), _("Fax"), _("Email"), _("Provision"), _("Break Pt."), _("Provision")." 2", "", "");
...
/*===================MOODLEARNING=========================*/
text_row_ex(_("IMC Code:"), 'imc_code', 20);
/*========================================================*/
